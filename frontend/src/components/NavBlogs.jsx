...
const NavBlogs = () => {
  ...
  return (
    <>
     ...
     <Navbar fixed="top" key='md' expand='md' className="bg-body-tertiary px-4">
          <Container fluid>
            ...
            >
              ...
              <Offcanvas.Body>
                <Nav className="justify-content-center flex-grow-1">
                  ...
                  <Nav.Link href="/blogs" className="text-primary fw-medium" style={{fontSize:"1.2rem"}}>Blogs</Nav.Link>
